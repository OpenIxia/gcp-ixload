...
locals {
	...
	GCP_CLIENT_INSTANCE_NAME = "ixload-client-01"
	GCP_CLIENT_CUSTOM_IMAGE_PROJECT_NAME = "ixvm-261016"
	GCP_CLIENT_CUSTOM_IMAGE_FAMILY_NAME = "ixia-windows-client-gcp-9-10-0-311"
	GCP_CLIENT_MACHINE_TYPE = var.GCP_CLIENT_MACHINE_TYPE
	GCP_CLIENT_IFACE_ETH0_PRIVATE_IP_ADDRESS = "10.0.10.10"
	GCP_CLIENT_IFACE_ETH0_PUBLIC_IP_ADDRESS_NAME = "ixload-client-01-eth0-ip-address"
	GCP_CLIENT_NETWORK_TARGET_TAGS = [
		"ixload-client"
	]
	GCP_VMONE1_INSTANCE_NAME = "ixload-vmone-01"
	GCP_VMONE2_INSTANCE_NAME = "ixload-vmone-02"
	GCP_VMONE_SERIAL_PORT_ENABLE = "true"
	GCP_VMONE_CUSTOM_IMAGE_PROJECT_NAME = "ixvm-261016"
	GCP_VMONE_CUSTOM_IMAGE_FAMILY_NAME = "ixia-virtual-test-appliance-9-10-119-1"
	...
	GCP_VMONE2_IFACE_ETH0_PUBLIC_IP_ADDRESS_NAME = "ixload-vmone-02-eth0-ip-addr"
